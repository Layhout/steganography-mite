...
class Decode(customtkinter.CTkFrame):
    def __init__(self, parent):
        ...
        self.method_optionmenu = customtkinter.CTkOptionMenu(self.action_frame, values=STEGANOGRAPHY_METHODS)
        self.method_optionmenu.grid(row=1, column=0, padx=20, pady=(0, 10), sticky="we")

        self.encode_button = customtkinter.CTkButton(self.action_frame, text="Decode", command=self.decode_event)
